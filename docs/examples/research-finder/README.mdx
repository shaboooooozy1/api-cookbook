...
Run the script from the `docs/examples/research-finder` directory or provide the full path.
...
python3 research_finder.py "Explain the concept of Large Language Models" --model sonar
