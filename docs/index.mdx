...
In-depth tutorials for advanced implementations and integrations with other tools, including the [Perplexity MCP server](/cookbook/articles/perplexity-mcp-server/README) for Claude Desktop, Claude Code, Cursor, and other MCP-compatible clients.
